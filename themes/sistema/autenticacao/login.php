                ...
                <form action="<?= url('/'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        <div class="input-group input-group-merge input-group-alternative">
                            ...
                            <input class="form-control" name="email" value="admin@admin.com" placeholder="Email"
                                   type="email">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group input-group-merge input-group-alternative">
                            ...
                            <input class="form-control" name="senha" value="123456" placeholder="Senha" type="password">
                        </div>
                    </div>
                    <div>
                        <a target="_blank"
