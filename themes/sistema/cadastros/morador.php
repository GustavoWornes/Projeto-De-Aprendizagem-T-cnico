                    ...
                    <div class="card-body">
                        <form action="<?= url("/morador/{$morador->id}") ?>" method="post">
                            ...
                            <div class="card-footer row">
                                ...
                                <div class="ml-2">
                                    <a href="<?= url('morador') ?>" class="btn btn-sm btn-success mb-2" style="width:90px;">NOVO</a>
                                </div>
                                <div class="ml-auto">
                                    <a href="<?= url('moradores') ?>" class="btn btn-sm btn-warning mb-2" style="width:90px;">CANCELAR</a>
                                </div>
                            </div>
                        </form>
                    </div>
